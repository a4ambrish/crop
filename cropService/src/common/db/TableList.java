...
/**
 * List of the tables used in . This is provided so that Table Names 
 * are not used directly in the code but through a constant variable
 * listed here. Idea is to have the flexibility at the development
 * time and to avoid mis-spelled table name in the SQL strings.
 *
 * @author AKS
 */
