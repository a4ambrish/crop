...
public class DataField extends ClientObject implements Serializable {
     ...
     * This should not be used by the "DOxxxx.java" objects code, instead 
     * the next constructor should be used.
     */
    ...
    /**
     * This constructor must only be used by the "DOxxxx.java" program
     * of the .
     */
 ...
 */
     ...
     * @param tableName Table name for which the update statement need to be generated
     *
