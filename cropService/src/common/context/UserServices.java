...
/** 
 * User Services class contains privileges for all the services for a user.
 * Six operations are available per service. Contains union of all the
 * roles and services allowed to a user. The object of this class is
 * populated at server side and serialized for the client handy access.
 * 
 * @author JIS
 */
public class UserServices extends ClientObject implements Serializable {
    ...
    ///////////////////////////////////////////////////////////////////////
    /**
     * List of all the services for the user. This list contains the
     * cummulative privileges for each service for all the roles the 
     * user have. Use above constants IDX_* to access the data from
     * this array.
     *
     * <PRE>
     ...
     * @param serviceid service which is checked.
     *
     * @return returns the index of the service in the list. If the
     *         serviceid does not exists then return -1
     */
     ...
     * @param actionid type of access (action) - Corresponds to the
     *                 index number in the services[][] array
     *
     * @return boolean returns true if the serviceid is valid and 
     *                 action is allowed.
     *
     ...
     *
     * @return List of allowed services, if no service is allowed 
     *         then returns null
     *
     * @throws UserServicesException
     */
     ...
     *
     * @return List of forbidden services, if no service is forbidden
     *         then returns null
     *             
     *
     * @throws UserServicesException.
