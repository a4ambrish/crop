...
/**
 * Provides Instance Count at any stage. Keeps count of the
 * objects live in the JVM and total number of objects created
 * so far during the life of the JVM running. This is essentially
 * used for debugging. A class wanting to know its instance count
 * should call "InstanceCount.add(this)" in all the constructors
...
public abstract class InstanceCount implements Serializable {
    ...
    ////////////////////////////////////////////////////////////////////////
    /**
     * Debugging on/off variable DEBUG is set separately by client and server
     * in ConfigClient and ConfigServer.java. This variable DO_COUNTING
     * is set using the DEBUG varibale from ConfigClient and ConfigServer.java
     * on client and server side respectively.
     *
     ...
     *
     * @param object Object for which the count need to manage
     * @param addFlag True if the given object is created false if garbage collected
     */
    ...
    /**
     * A utility method to generate a report for the instance count list
     * in given ArrayList
     *
