...
public abstract class ZipUtils {
     ...
     * @param dataFileName The name of the file that will be
     *                     encompass within thw Zip file having
     *                     the content
    ...
    /**
     * Zip the given File. This will zip the file in the dir where
     * the source file is and the zip file name will be the source
     * file name minus any last '.extention' plus ".zip".
     *
