...
public class NumberToWords {
     ...
     * Breaks a given number into various Indian number parts. There are
     * total five parts ie ...
     * <PRE>
     ...
     *         (eg 99120008763      :  NINE THOUSAND NINE HUNDRED 
     *                                 TWELVE CRORE EIGHT THOUSAND SEVEN 
    ...
    /**
     * Breaks a given number into various Indian number parts. There are
     * total five parts this method returns ie ...
     * <PRE>
     *                  Crores Lakhs Thousands Hundreds Tens
     * 25709704517      2570,  97,   04,       5,       17
     * </PRE>
     * If some part is not there then this returns null for that part
     * in the return String array. If the number is a negative number
     * then the sixth element of the returned array will have a not null value
     * to reflect that the number is a negative one.
     *
     * @param number Given number to convert into the number word parts
     *
    ...
    /**
     * Returns a word representaion of given maximum of two digit number (eg 17, 9)
     *
